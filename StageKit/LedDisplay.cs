namespace StageKit
{
    ...
    public class LedDisplay : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static explicit operator LedDisplay(int key)
        {
            ...
            display.RedLedArray = new LedColor((byte)(key >> 24));
            display.GreenLedArray = new LedColor((byte)(key >> 16));
            display.YellowLedArray = new LedColor((byte)(key >> 8));
            display.BlueLedArray = new LedColor((byte)key);
            display.BindEvents();
            return display;
        }
        ...
        {
            RedLedArray.PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(LedChanged);
            YellowLedArray.PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(LedChanged);
            GreenLedArray.PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(LedChanged);
            BlueLedArray.PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(LedChanged);
        }
    }
}
